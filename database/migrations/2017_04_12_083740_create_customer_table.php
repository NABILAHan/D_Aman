...
class CreateCustomerTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('customers', function (Blueprint $table) {
            ...
            $table->integer('book_meeting_id')->unsigned();
            $table->foreign('book_meeting_id')->references('id')->on('booking_meetings')->onDelete('cascade')->onUpdate('cascade');

            $table->integer('book_room_id')->unsigned();
            $table->foreign('book_room_id')->references('id')->on('booking_rooms')->onDelete('cascade')->onUpdate('cascade');
            $table->timestamps();
        });
    }
