...
<br><br>
 ...
 <div class="row">
        ...
        <div class="input-field col s6">
          <input name="address" id="last_name" type="text" class="validate" value="{{$cus->cus_address}}">
          <label for="last_name">{{ trans('messageRg.Address') }}</label>
        </div>
        <div class="input-field col s6">
          <input name="country" id="last_name" type="text" class="validate" value="{{$cus->cus_country}}" >
          <label for="last_name">{{ trans('messageRg.Country') }}</label>
        </div>
        <div class="input-field col s6">
          <input name="state" id="last_name" type="text" class="validate" value="{{$cus->cus_state}}">
          <label for="last_name">{{ trans('messageRg.State') }}</label>
        </div>
        <div class="input-field col s6">
          <input name="city" id="last_name" type="text" class="validate" value="{{$cus->cus_city}}">
          <label for="last_name">{{ trans('messageRg.City') }}</label>
          </div>
          <div class="input-field col s6">
          <input name="postalcode" id="last_name" type="text" class="validate" value="{{$cus->cus_country}}">
