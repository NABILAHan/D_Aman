 ...
 <section>
  <div  class="parallax-container">
    ...
    <div class="parallax"><img src="{{asset('img/room/mr6.jpg')}}" alt="Unsplashed background img 1"></div>
  </div>
</section>
<br>
<div class="row">
 <div class="col s12">
   <div class="row">
    <div class="col s12 m4">
      <div class="card">
        ...
        <div class="row center">
          <a href="{{url('roo_l')}}" id="download-button" class="btn-large waves-effect waves-light blue white-text">{{ trans('meet.View') }}</a>
        </div>
      </div>
    </div>
    <div class="col s12 m4">
      ...
      <div class="row center">
        <a href="{{url('LM')}}" id="download-button" class="btn-large waves-effect waves-light blue white-text">{{ trans('meet.View') }}</a>
      </div>
  ...
  <div class="col s12 m4">
    <div class="card">
      ...
      <div class="row center">
        <a href="http://materializecss.com/getting-started.html" id="download-button" class="btn-large waves-effect waves-light blue white-text">{{ trans('meet.View') }}</a>
      </div>
    </div>
  </div>
</div>
