    ...
    <div class="nav-wrapper indigo darken-4">
      ...
      <dd><ul class="left hide-on-med-and-down">
        ...
        <a class="waves-effect waves-light btn indigo accent-4 modal-trigger" href="#modal2">{{ trans('meet.Rg') }}</a>
         <a class="waves-effect waves-light btn indigo accent-4 modal-trigger" href="#modal1">{{ trans('meet.Rg') }}</a>
           @endif
           <li> <a href="{{url('admin')}}"><i class="material-icons right ">perm_identity</i></a></li>
